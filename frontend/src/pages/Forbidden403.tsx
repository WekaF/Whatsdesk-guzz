...
export default function Forbidden403() {
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center p-4">
      <div className="max-w-md w-full glass-card rounded-2xl p-8 text-center space-y-6 relative overflow-hidden border border-red-500/20 shadow-[0_0_50px_rgba(239,68,68,0.05)]">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center pt-4 relative z-10">
          <button
            ...
            className="flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl border border-slate-200 dark:border-slate-800 hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-655 dark:text-slate-300 font-semibold text-sm transition-all cursor-pointer"
          >
          ...
          <button
            onClick={() => navigate('/')}
            className="flex items-center justify-center gap-2 bg-whatsapp hover:bg-emerald-500 text-black px-5 py-2.5 rounded-xl font-semibold text-sm transition-all cursor-pointer glow-green shadow"
          >
